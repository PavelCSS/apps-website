...
export const PrivacyPolicyContainer: FC<PrivacyPolicyContainerProps> = ({
  title,
  pageTitle,
}) => {
  useTitle(pageTitle);
  ...
  return (
    <AppView>
      ...
      <Box overflow={"auto"} pb={5} px={3}>
        ...
        >
          <Typography>
            Yashin Pavlo built the {title} app as a Freemium app. This SERVICE
            is provided by Yashin Pavlo at no cost and is intended for use as
            is.
          </Typography>
          <Typography>
          ...
          <Typography>
            ...
            our Terms and Conditions, which are accessible at {title}
          ...
          <Typography>This policy is effective as of 2023-08-01</Typography>
          <Typography variant={"h6"}>Contact Us</Typography>
          <Typography>
            If you have any questions or suggestions about my Privacy Policy, do
            not hesitate to contact me at yashin.ziby@gmail.com.
          </Typography>
          <Typography>
